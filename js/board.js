...
Board.prototype.place = function(column) {
    ...
    // it is invalid only when the column is completely filled
...
Board.prototype.score = function() {
    ...
    // [x][x][x][ ][ ][ ][ ] 2          [x][x][x][x][x][x][x] 2
    // [x][x][x][ ][ ][ ][ ] 3          [x][x][x][x][x][x][x] 3
    // [ ][x][x][ ][ ][ ][ ] 4          [x][x][x][x][x][x][x] 4
    // [ ][ ][x][ ][ ][ ][ ] 5          [ ][ ][ ][ ][ ][ ][ ] 5
 ...
 * To check complete fullness - this is only checking top row... if anything is null there that means board is not yet full. - NICE
 *
 * @return {boolean}
 */
